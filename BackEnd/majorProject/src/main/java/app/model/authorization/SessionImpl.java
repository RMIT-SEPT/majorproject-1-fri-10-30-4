...
public class SessionImpl {
	...
	//Default constructor needed for autowire. Do not use.
	public SessionImpl(){}
	...
	public SessionImpl(int userId, String sourceIp, long secondsToExpire) {
		...
		this.expirationDateTime = this.creationDateTime.plusSeconds(secondsToExpire);
		this.randomValue = Math.random();
		this.checkHash = this.getHashForSession();
		}
	
	private String getHashForSession() {
		StringBuilder objectString = new StringBuilder();
		objectString.append(Double.toString(this.randomValue));
		objectString.append(Integer.toString(this.userId));
		objectString.append(this.sourceIp);
		objectString.append(this.creationDateTime.toString());
		return dbtools.PasswordHash.createHash(objectString.toString());
	}
